...
const Delivery = () => {
    ...
    const [address,setAdderess]=useState(deliveryInfo.address);
    const [city,setCity]=useState(deliveryInfo.postalCode);
    ...
    <div className='row wrapper'>
        <div className='col-10 col-lg-5 cartt'>
            <form onSubmit={submitHandler}>
                ...
                id='shipping_btn'
                type='submit'
                className='btn btn-block py-3'>Continue</button>
            </form>
        </div>
    </div>
    </>
